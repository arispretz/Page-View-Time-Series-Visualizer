...
# Ensure the 'static' directory exists and has write permissions
...
def draw_line_plot():
    ...
    try:
        fig.savefig(f'{static_dir}/line_plot.png')
...
def draw_bar_plot():
    ...
    # Save image and return fig (don't change this part)
    try:
        fig.savefig(f'{static_dir}/bar_plot.png')
    except PermissionError as e:
        print(f"Permission error: {e}")
    return fig
...
def draw_box_plot():
    ...
    # Save image and return fig (don't change this part)
    try:
        fig.savefig(f'{static_dir}/box_plot.png')
    except PermissionError as e:
        print(f"Permission error: {e}")
    return fig
